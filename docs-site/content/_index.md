---
title: Homelab IaC Documentation
description: Terraform and Ansible homelab infrastructure documentation / 家庭实验室基础设施文档
...
[按主题浏览现有文档。/ Browse the existing documentation by topic.](docs/)

## Agent 输出 / Agent output

[读取站点索引或每页 Markdown alternate。/ Read the site index or each page's Markdown alternate.](llms.txt)
