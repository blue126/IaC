...
Finally, verify the Netbox deployment and API connectivity by creating initial sample resources (Site, Cluster, VM). This step confirms that Terraform can successfully authenticate and write data to Netbox.
- **Directory**: `terraform/netbox-integration`
- **Provider**: `e-breuninger/netbox-integration` (v3.10.0)
- **Managed Resources**:
  - Sites (e.g., HomeLab)
