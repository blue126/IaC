...
版本：v4 修订 7.6。更新：2026-09-23。只创建一支 Squad，复用五个 BMAD 业务 persona 与一个轻量 Coordinator。
...
Issue 中的日常问答只定向给需要回答的人。创建、恢复、跨角色交接或结束子项时读取合同 C3；不得用状态变更、Issue 链接或文字承诺冒充已触发派工。评论回复遵守本轮真实触发评论与平台权限。
