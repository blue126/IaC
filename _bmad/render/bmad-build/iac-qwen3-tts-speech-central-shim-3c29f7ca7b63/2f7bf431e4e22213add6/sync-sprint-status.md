...
- `story_key` is unset
- `/Users/weierfu/Projects/IaC-qwen3-tts-speech-central-shim/_bmad-output/implementation-artifacts/sprint-status.yaml` does not exist on disk

## Instructions

1. Load the FULL `/Users/weierfu/Projects/IaC-qwen3-tts-speech-central-shim/_bmad-output/implementation-artifacts/sprint-status.yaml` file.
